            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3.5 pr-12 rounded-xl bg-slate-50 border-2 border-slate-200 text-slate-800 font-medium focus:ring-4 focus:ring-purple-100 focus:border-purple-400 transition-all"
